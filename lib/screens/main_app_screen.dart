...
import 'package:iuo_mobile_app/screens/more_details.dart';
...
class _MainAppScreenState extends State<MainAppScreen> {
  ...
  Widget getButtonUI(CategoryType categoryTypeData, bool isSelected) {
    ...
    return Expanded(
      child: Container(
        decoration: BoxDecoration(color: isSelected ? DesignCourseAppTheme.nearlyBlue : DesignCourseAppTheme.nearlyWhite, borderRadius: const BorderRadius.all(Radius.circular(24.0)), border: Border.all(color: DesignCourseAppTheme.nearlyBlue)),
        child: Material(
